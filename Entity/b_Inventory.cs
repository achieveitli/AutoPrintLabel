...
namespace Entity
{
    ...
    public partial class b_Inventory
    {
        ...
        public Nullable<int> bInvType { get; set; }
        ...
        public string cInvVenStd { get; set; }
        ...
        public string cCheck_IQC { get; set; }
        public string cCheck_IPQC { get; set; }
        public string cCheck_FQC { get; set; }
        public string cCheck_OQC { get; set; }
        public string cCheck_Other { get; set; }
        public byte bPlanInv { get; set; }
        ...
        public Nullable<short> iSupplyType { get; set; }
        ...
        public string cCIS0AQL { get; set; }
        ...
        public Nullable<double> fGrossJ { get; set; }
        ...
        public Nullable<double> ROPDayDissipat { get; set; }
        public Nullable<double> ROPLevel { get; set; }
        public Nullable<double> ROPMoorQuan { get; set; }
        public Nullable<double> ROPMoorAheardDate { get; set; }
        public string Fselect { get; set; }
        public string cCheckModel1 { get; set; }
        public string cCheckModel2 { get; set; }
        public string cFGKind2 { get; set; }
        public string cInvDefine3In { get; set; }
        public string cInvNameIn { get; set; }
        public string cKuangJName { get; set; }
        public string cHanXRequire { get; set; }
        public string cPurchaseUse { get; set; }
    }
}
