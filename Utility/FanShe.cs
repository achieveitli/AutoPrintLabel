...
namespace Utility
{
    public static class FanShe
    {
        ...
        public static D MapperToModel<D, S>(D d, S s)
        {
            ...
            return d;
			//SubStrings subs = format.SubStrings;
                    //foreach (SubString sub in subs)
                    //{
                    //    foreach (V_DisAll_Lists vDis in _vDisAllLists)
                    //    {
                    //         var types = vDis.GetType();
                    //         foreach (PropertyInfo property in types.GetProperties())
                    //        {
                    //            if (property.Name==sub.Name)
                    //            {
                    //                sub.Value = property.GetValue(vDis, null).ToString();
                    //            }
                    //        }
                    //    }
                    //}
